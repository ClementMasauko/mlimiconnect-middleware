...
WEATHER_FALLBACK_API_URL = os.getenv("WEATHER_FALLBACK_API_URL", "https://api.met.no/weatherapi/locationforecast/2.0/compact").rstrip("/")
WEATHER_USER_AGENT = os.getenv("WEATHER_USER_AGENT", "MlimiConnect/1.0 https://mlimiconnect.netlify.app/contact")
...
GEOAPIFY_API_URL = os.getenv("GEOAPIFY_API_URL", "https://api.geoapify.com/v1/geocode/search").rstrip("/")
